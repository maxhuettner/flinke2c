...
public class DefaultSchedulerComponents {
    ...
    private static DefaultSchedulerComponents createPipelinedRegionSchedulerComponents(
        ...
        final ExecutionSlotAllocatorFactory allocatorFactory = ExecutionSlotAllocatorFactoryUtils.selectExecutionSlotAllocatorFactory(jobType, jobMasterConfiguration, physicalSlotProvider, bulkChecker, slotRequestTimeout);
