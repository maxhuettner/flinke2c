...
public class TaskExecutorManagerBuilder {
    ...
    private String taskManagerAddress = "localhost";
    ...
    public TaskExecutorManagerBuilder setTaskManagerAddress(String taskManagerAddress) {
    ...
    public TaskExecutorManager createTaskExecutorManager() {
        return new TaskExecutorManager(
                ...
                scheduledExecutor,
                mainThreadExecutor,
                newResourceAllocator, taskManagerAddress);
    }
}
