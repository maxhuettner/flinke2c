...
\addplot[mark=none, color=color1, solid] table[x=x, y=ecdf, col sep=comma] {plot_data/flink_placement_abs_q1_hom_hom_ecdf.csv};
\addlegendentry{Cloud}
\addplot[mark=none, color=color2, dashed] table[x=x, y=ecdf, col sep=comma] {plot_data/flink_placement_abs_q1_hom_het_ecdf.csv};
\addlegendentry{Mixed}
\addplot[mark=none, color=color3, dotted] table[x=x, y=ecdf, col sep=comma] {plot_data/flink_placement_abs_q1_het_het_ecdf.csv};
